...
* **Projects and Cluster**: selector/content-panel following the Comrades rules, with the selector panel listing relevant objects and optional non-selectable headings, and the content panel showing context, status, actions, and details for the selected item. Routing and Tasks are Cluster selector items; placeholder content belongs in the content panel until real selectable objects are wired.
