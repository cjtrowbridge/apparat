...
* Ability to inspect relevant documentation (`AGENTS.md`, `README.md`, `./playbooks/`, `./references/`, `./templates/`) when affected; use `references/verification_patterns_for_docs_and_policy.md` for documentation-policy verification.
