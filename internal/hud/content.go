...
func clusterTab() Tab {
	return tab(DefaultConfigManager{}.Config(), TabCluster, "Local diagnostics, mock device capability inventory, and typed workload routing.", []Section{{Title: "Local Runtime", Description: "Runtime diagnostics summarize this device before real cluster enrollment exists.", Rows: []Row{{Label: "Identity", Detail: "classified by doctor"}, {Label: "Runtime root", Detail: "shown in Settings"}, {Label: "last_run.log", Detail: "reset on each start"}}}, {Title: "Mock Devices", Description: "Cluster will become a device list with selected-device context.", Rows: []Row{{Label: "steamdeck", Detail: "GUI console"}, {Label: "worker", Detail: "text_generation, speech_to_text"}, {Label: "workstation", Detail: "image_generation, video_generation, research_boinc"}}}, {Title: "Routing", Description: "Typed workload queues, compatibility filters, and fallback routing belong to Cluster.", DetailSections: routingSections()}})
}
