...
| Field | Value |
| --- | --- |
| Advisory report | `plans/past/phase-7-review/deep-research.md` |
...
4. The report's function-comment measurement was not accompanied by its original script. `plans/past/phase-7-review/README.md` records the replacement measurement and its deliberately narrow semantics.
