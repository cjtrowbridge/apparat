...
- [ ] 1. Recover a safe implementation checkout before modifying product code.
  - [ ] 1.1 Preserve the current local documentation edits and any intentionally retained local commits.
  - [ ] 1.2 Reclone or otherwise reconcile this checkout with the rewritten public history without reintroducing the removed `artifacts/` history.
  - [ ] 1.3 Verify the recovered checkout is based on the rewritten public `main` before creating a working branch.
