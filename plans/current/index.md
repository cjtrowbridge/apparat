...
2026-07-12-22-17-43 | plans/current/2026-07-12-21-33-14_add-scrollable-hud-scenario-data.md | Add Scrollable HUD Scenario Data | Populate each HUD tab with realistic multi-page scenario data and make every body, master-list, and detail viewport scroll only within the area between the tab strip and diagnostics bar.
